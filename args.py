...
def get_parser():
    ...
    parser.add_argument('--TFIDFDim', default=1024, type=int)
    parser.add_argument('--imgCLSVecDim', default=1024, type=int)
    ...
    parser.add_argument('--result_dir', default='MSJE', type=str)
